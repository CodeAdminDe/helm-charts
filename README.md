...
| coturn-server | 0.1.0 | 4.8.0 | A Helm chart for an easier coturn deployment at kubernetes. |
| libchart-cnps | 0.2.1 | 0.2.0 | A (experimental) Helm chart of cilium network policies for usage as a library chart. |
| netbird-agent | 0.7.7 | 0.62.1 | A Helm chart for an easier netbird agent (https://netbird.io) deployment at kubernetes. |
| netbird-management | 1.7.7 | 0.62.1 | A Helm chart for an easier netbird management stack (https://netbird.io) deployment at kubernetes. |
...
| webfinger | 0.2.3 | 0.7.3 | A Helm chart for an easy webfinger deployment at kubernetes. |
