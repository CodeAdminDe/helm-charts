...
| netbird-agent | 0.5.2 | 0.61.0 | A Helm chart for an easier netbird agent (https://netbird.io) deployment at kubernetes. |
| netbird-management | 1.3.1 | 0.60.9 | A Helm chart for an easier netbird management stack (https://netbird.io) deployment at kubernetes. |
...
| webfinger | 0.2.2 | 0.7.2 | A Helm chart for an easy webfinger deployment at kubernetes. |
