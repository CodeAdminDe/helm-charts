...
| outline | 0.11.0 | 0.87.3 | A Helm chart for an easier outline (https://getoutline.com) deployment at kubernetes. |
| redis | 0.1.1 | 8.2.1 | A Helm chart for Redis k8s deployment, based on library/redis |
