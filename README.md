...
| netbird-agent | 0.8.0 | 0.63.0 | A Helm chart for an easier NetBird agent (https://netbird.io) deployment at kubernetes. |
| netbird-management | 1.10.5 | 0.63.0 | A Helm chart for an easier NetBird management stack (https://netbird.io) deployment at kubernetes. |
...
| webfinger | 0.2.4 | 0.7.4 | A Helm chart for an easy webfinger deployment at kubernetes. |
