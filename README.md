...
| netbird-agent | 0.7.2 | 0.61.2 | A Helm chart for an easier netbird agent (https://netbird.io) deployment at kubernetes. |
| netbird-management | 1.7.5 | 0.62.0 | A Helm chart for an easier netbird management stack (https://netbird.io) deployment at kubernetes. |
