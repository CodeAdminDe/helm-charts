...
| libchart-cnps | 0.1.0 | 0.1.0 | A (experimental) Helm chart of cilium network policies for usage as a library chart. |
| ollama | 0.13.3 | 0.13.3 | A Helm chart for an easier ollama (https://ollama.com) deployment on k8s. Please note that this is a private helm chart and not directly or indirectly affiliated with ollama or its authors. |
