...
| headscale | 0.1.0 | 0.28.0 | A Helm chart for an easier headscale (https://headscale.net) deployment on Kubernetes. Please note that this is a private helm chart and not directly or indirectly affiliated with headscale or its authors. |
...
| netbird-management | 1.14.2 | 0.65.2 | A Helm chart for an easier NetBird management stack (https://netbird.io) deployment at kubernetes. |
| ollama | 0.19.0 | 0.17.0 | A Helm chart for an easier ollama (https://ollama.com) deployment on k8s. Please note that this is a private helm chart and not directly or indirectly affiliated with ollama or its authors. |
| outline | 1.10.1 | 1.5.0 | A Helm chart for an easier outline (https://getoutline.com) deployment at kubernetes. |
