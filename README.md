...
| netbird-agent | 0.7.6 | 0.62.1 | A Helm chart for an easier netbird agent (https://netbird.io) deployment at kubernetes. |
| netbird-management | 1.7.6 | 0.62.1 | A Helm chart for an easier netbird management stack (https://netbird.io) deployment at kubernetes. |
