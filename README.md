...
| ollama | 0.16.2 | 0.14.3 | A Helm chart for an easier ollama (https://ollama.com) deployment on k8s. Please note that this is a private helm chart and not directly or indirectly affiliated with ollama or its authors. |
...
| webfinger | 0.2.7 | 0.7.7 | A Helm chart for an easy webfinger deployment at kubernetes. |
