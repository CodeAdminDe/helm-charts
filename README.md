...
| netbird-agent | 0.6.7 | 0.61.2 | A Helm chart for an easier netbird agent (https://netbird.io) deployment at kubernetes. |
| netbird-management | 1.4.2 | 0.61.2 | A Helm chart for an easier netbird management stack (https://netbird.io) deployment at kubernetes. |
