...
| ollama | 0.12.11 | 0.12.10 | A Helm chart for an easier ollama (https://ollama.com) deployment on k8s. Please note that this is a private helm chart and not directly or indirectly affiliated with ollama or its authors. |
| outline | 1.0.6 | 1.0.1 | A Helm chart for an easier outline (https://getoutline.com) deployment at kubernetes. |
