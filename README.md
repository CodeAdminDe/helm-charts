...
| outline | 0.12.1 | 0.87.3 | A Helm chart for an easier outline (https://getoutline.com) deployment at kubernetes. |
| redis | 0.2.3 | 8.2.1 | A Helm chart for Redis k8s deployment, based on library/redis |
