...
![Version: 0.7.25](https://img.shields.io/badge/Version-0.7.25-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.85.1](https://img.shields.io/badge/AppVersion-0.85.1-informational?style=flat-square)
...
|------------|------|---------|
| https://charts.bitnami.com/bitnami | minio(minio) | 17.0.13 |
| https://charts.bitnami.com/bitnami | postgresql(postgresql) | 16.7.20 |
| https://charts.bitnami.com/bitnami | redis(redis) | 21.2.12 |
