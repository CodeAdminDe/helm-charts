...
![Version: 1.3.4](https://img.shields.io/badge/Version-1.3.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.1.0](https://img.shields.io/badge/AppVersion-1.1.0-informational?style=flat-square)
...
|------------|------|---------|
| https://charts.bitnami.com/bitnami | postgresql(postgresql) | 18.1.14 |
| https://codeadminde.github.io/helm-charts | libchart-cnps(libchart-cnps) | 0.1.1 |
| https://codeadminde.github.io/helm-charts | redis(redis) | 0.3.0 |
...
<table height="800px" >
	...
	<tbody>
		<tr>
			<td id="additionalEnvSecrets"><a href="./values.yaml#L176">additionalEnvSecrets</a></td>
			<td>
string
</td>
			<td>
...
null
		...
		<tr>
			<td id="affinity"><a href="./values.yaml#L367">affinity</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="autoscaling"><a href="./values.yaml#L343">autoscaling</a></td>
			<td>
object
</td>
			<td>
  ...
  "appTraffic": {
    ...
    "ingress": {
      ...
      "matchLabels": {}
		...
		<tr>
			<td id="env"><a href="./values.yaml#L153">env</a></td>
			<td>
string
</td>
			<td>
...
null
		...
		<tr>
			<td id="existingEnvSecret"><a href="./values.yaml#L161">existingEnvSecret</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="fileStorage"><a href="./values.yaml#L121">fileStorage</a></td>
			<td>
object
</td>
			<td>
...
[]
		...
		<tr>
			<td id="ingress"><a href="./values.yaml#L278">ingress</a></td>
			<td>
object
</td>
			<td>
  ...
  "tls": [
    {
      ...
      "secretName": ""
		...
		<tr>
			<td id="ingress--tls[0]--secretName"><a href="./values.yaml#L305">ingress.tls[0].secretName</a></td>
			<td>
string
</td>
			<td>
...
<pre lang="json">
{
  ...
  "includeCnpgPolicies": false
		...
		<tr>
			<td id="livenessProbe--failureThreshold"><a href="./values.yaml#L331">livenessProbe.failureThreshold</a></td>
			<td>
int
</td>
			<td>
...
3
		...
		<tr>
			<td id="livenessProbe--httpGet--path"><a href="./values.yaml#L329">livenessProbe.httpGet.path</a></td>
			<td>
string
</td>
			<td>
...
"/_health"
		...
		<tr>
			<td id="livenessProbe--httpGet--port"><a href="./values.yaml#L330">livenessProbe.httpGet.port</a></td>
			<td>
int
</td>
			<td>
...
3000
		...
		<tr>
			<td id="livenessProbe--initialDelaySeconds"><a href="./values.yaml#L333">livenessProbe.initialDelaySeconds</a></td>
			<td>
int
</td>
			<td>
...
60
		...
		<tr>
			<td id="livenessProbe--periodSeconds"><a href="./values.yaml#L332">livenessProbe.periodSeconds</a></td>
			<td>
int
</td>
			<td>
...
{}
		...
		<tr>
			<td id="persistence"><a href="./values.yaml#L129">persistence</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "storageClass": "longhorn"
		...
		<tr>
			<td id="persistence--accessModes"><a href="./values.yaml#L145">persistence.accessModes</a></td>
			<td>
list
</td>
			<td>
...
[
  "ReadWriteOnce"
		...
		<tr>
			<td id="persistence--cacheDirHomeSizeLimit"><a href="./values.yaml#L139">persistence.cacheDirHomeSizeLimit</a></td>
			<td>
string
</td>
			<td>
...
"100Mi"
		...
		<tr>
			<td id="persistence--cacheDirTmpSizeLimit"><a href="./values.yaml#L137">persistence.cacheDirTmpSizeLimit</a></td>
			<td>
string
</td>
			<td>
...
"100Mi"
		...
		<tr>
			<td id="persistence--emptyDirSizeLimit"><a href="./values.yaml#L135">persistence.emptyDirSizeLimit</a></td>
			<td>
string
</td>
			<td>
...
"500Mi"
		...
		<tr>
			<td id="persistence--enabled"><a href="./values.yaml#L133">persistence.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="persistence--size"><a href="./values.yaml#L141">persistence.size</a></td>
			<td>
string
</td>
			<td>
...
"1Gi"
		...
		<tr>
			<td id="persistence--storageClass"><a href="./values.yaml#L143">persistence.storageClass</a></td>
			<td>
string
</td>
			<td>
...
<pre lang="json">
{
  "fsGroup": 1000
		...
		<tr>
			<td id="postgresql"><a href="./values.yaml#L200">postgresql</a></td>
			<td>
object
</td>
			<td>
  ...
  "primary": {
    "persistence": {
      ...
      "storageClass": ""
		...
		<tr>
			<td id="provideS3storeApiAsIngressSubpath"><a href="./values.yaml#L260">provideS3storeApiAsIngressSubpath</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "pathType": "ImplementationSpecific"
		...
		<tr>
			<td id="provideS3storeApiAsIngressSubpath--additionalAnnotations"><a href="./values.yaml#L266">provideS3storeApiAsIngressSubpath.additionalAnnotations</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "nginx.ingress.kubernetes.io/server-snippet": "location /ol-data-path/s3store/v2/metrics/cluster {\n    deny all;\n    return 403 \"Forbidden\";\n}\n"
		...
		<tr>
			<td id="provideS3storeApiAsIngressSubpath--additionalAnnotations--"nginx--ingress--kubernetes--io/server-snippet""><a href="./values.yaml#L268">provideS3storeApiAsIngressSubpath.additionalAnnotations."nginx.ingress.kubernetes.io/server-snippet"</a></td>
			<td>
string
</td>
			<td>
...
"location /ol-data-path/s3store/v2/metrics/cluster {\n    deny all;\n    return 403 \"Forbidden\";\n}\n"
		...
		<tr>
			<td id="provideS3storeApiAsIngressSubpath--enabled"><a href="./values.yaml#L262">provideS3storeApiAsIngressSubpath.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="readinessProbe--failureThreshold"><a href="./values.yaml#L338">readinessProbe.failureThreshold</a></td>
			<td>
int
</td>
			<td>
...
3
		...
		<tr>
			<td id="readinessProbe--httpGet--path"><a href="./values.yaml#L336">readinessProbe.httpGet.path</a></td>
			<td>
string
</td>
			<td>
...
"/_health"
		...
		<tr>
			<td id="readinessProbe--httpGet--port"><a href="./values.yaml#L337">readinessProbe.httpGet.port</a></td>
			<td>
int
</td>
			<td>
...
3000
		...
		<tr>
			<td id="readinessProbe--initialDelaySeconds"><a href="./values.yaml#L340">readinessProbe.initialDelaySeconds</a></td>
			<td>
int
</td>
			<td>
...
60
		...
		<tr>
			<td id="readinessProbe--periodSeconds"><a href="./values.yaml#L339">readinessProbe.periodSeconds</a></td>
			<td>
int
</td>
			<td>
...
10
		...
		<tr>
			<td id="redis"><a href="./values.yaml#L185">redis</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "persistence": {
    ...
    "storageClass": ""
		...
		<tr>
			<td id="redisAuthEnabled"><a href="./values.yaml#L192">redisAuthEnabled</a></td>
			<td>
bool
</td>
			<td>
...
1
		...
		<tr>
			<td id="resources"><a href="./values.yaml#L308">resources</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="runtimeClass"><a href="./values.yaml#L109">runtimeClass</a></td>
			<td>
object
</td>
			<td>
...
<i>Source and more informations: https://kubernetes.io/docs/concepts/containers/runtime-class/ </i>
		...
		<tr>
			<td id="runtimeClass--jobs"><a href="./values.yaml#L113">runtimeClass.jobs</a></td>
			<td>
...
""
		...
		<tr>
			<td id="runtimeClass--pods"><a href="./values.yaml#L111">runtimeClass.pods</a></td>
			<td>
<a href="#stringruntimeclassname" title="Click to get details">string/runtimeClassName</a>
</td>
			<td>
...
""
		...
		<tr>
			<td id="runtimeClass--tests"><a href="./values.yaml#L115">runtimeClass.tests</a></td>
			<td>
<a href="#stringruntimeclassname" title="Click to get details">string/runtimeClassName</a>
</td>
			<td>
...
""
		...
		<tr>
			<td id="s3store"><a href="./values.yaml#L232">s3store</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "name": ""
		...
		<tr>
			<td id="startupProbe"><a href="./values.yaml#L321">startupProbe</a></td>
			<td>
object
</td>
			<td>
...
[]
		...
		<tr>
			<td id="uploadMaxSize"><a href="./values.yaml#L126">uploadMaxSize</a></td>
			<td>
string
</td>
			<td>
...
"26214400"
		...
		<tr>
			<td id="useCnpgCluster"><a href="./values.yaml#L222">useCnpgCluster</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "enabled": true
		...
		<tr>
			<td id="volumeMounts"><a href="./values.yaml#L358">volumeMounts</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="volumes"><a href="./values.yaml#L351">volumes</a></td>
			<td>
list
</td>
			<td>
