...
![Version: 0.2.4](https://img.shields.io/badge/Version-0.2.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.20.10](https://img.shields.io/badge/AppVersion-2.20.10-informational?style=flat-square)
...
```</td>
		...
		<tr>
			<td id="affinity"><a href="./values.yaml#L648">affinity</a></td>
			<td>
object
</td>
			<td>
...
[]
		...
		<tr>
			<td id="cnps--appTraffic--egress--toEntities"><a href="./values.yaml#L628">cnps.appTraffic.egress.toEntities</a></td>
			<td>
list
</td>
			<td>
...
[
  "world"
		...
		<tr>
			<td id="cnps--appTraffic--egress--toPorts"><a href="./values.yaml#L631">cnps.appTraffic.egress.toPorts</a></td>
			<td>
list
</td>
			<td>
...
""
		...
		<tr>
			<td id="nodeSelector"><a href="./values.yaml#L642">nodeSelector</a></td>
			<td>
object
</td>
			<td>
...
true
		...
		<tr>
			<td id="podAnnotations"><a href="./values.yaml#L636">podAnnotations</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="podLabels"><a href="./values.yaml#L639">podLabels</a></td>
			<td>
object
</td>
			<td>
