...
![Version: 0.7.3](https://img.shields.io/badge/Version-0.7.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.62.0](https://img.shields.io/badge/AppVersion-0.62.0-informational?style=flat-square)
...
<table height="800px" >
	...
	<tbody>
		<tr>
			<td id="additionalEnvSecrets"><a href="./values.yaml#L175">additionalEnvSecrets</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="affinity"><a href="./values.yaml#L344">affinity</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="agent"><a href="./values.yaml#L107">agent</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "ssh": {
    ...
    "enableSftp": false
		...
		<tr>
			<td id="agent--adminUrl"><a href="./values.yaml#L115">agent.adminUrl</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="agent--caEnableRootless"><a href="./values.yaml#L133">agent.caEnableRootless</a></td>
			<td>
bool
</td>
			<td>
...
true
			...
			<td>- Enable / Disable rootless mode @description Decide if the agent should be deployed as rootless-mode or root-mode with extended permissions. When enabled, the deployment will configure the agent to use NETSTACK_MODE to provide a socks5 proxy and tries to use as less permissions as possible. (caEnableRootless: true) (RECOMMENDED) When disabled, the agent pod will require additional permissions and will be deployed with the the rootSecurityContext and rootPodSecurityContext values. (caEnableRootless: false) (NOT recommmended) Please note that i'd not recommend to run pods with extended and/or root permissions within prod envs. More details about NetBird rootless behaviour: https://docs.netbird.io/use-cases/netbird-on-faas#docker</td>
		</tr>
		<tr>
			<td id="agent--caInitPreConfig"><a href="./values.yaml#L135">agent.caInitPreConfig</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "enabled": true
		...
		<tr>
			<td id="agent--caInitPreConfig--enabled"><a href="./values.yaml#L140">agent.caInitPreConfig.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="agent--logFilePath"><a href="./values.yaml#L124">agent.logFilePath</a></td>
			<td>
string
</td>
			<td>
...
"/var/lib/netbird/client.log"
		...
		<tr>
			<td id="agent--logFormat"><a href="./values.yaml#L120">agent.logFormat</a></td>
			<td>
string
</td>
			<td>
...
"console"
		...
		<tr>
			<td id="agent--logLevel"><a href="./values.yaml#L117">agent.logLevel</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="agent--managementUrl"><a href="./values.yaml#L111">agent.managementUrl</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="agent--socksPort"><a href="./values.yaml#L143">agent.socksPort</a></td>
			<td>
string
</td>
			<td>
...
null
		...
		<tr>
			<td id="agent--ssh"><a href="./values.yaml#L145">agent.ssh</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "enableSftp": false
		...
		<tr>
			<td id="agent--ssh--allowServer"><a href="./values.yaml#L148">agent.ssh.allowServer</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="agent--ssh--enableRoot"><a href="./values.yaml#L151">agent.ssh.enableRoot</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="agent--ssh--enableSftp"><a href="./values.yaml#L154">agent.ssh.enableSftp</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="cnps"><a href="./values.yaml#L190">cnps</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "cnpgTraffic": {
    "instanceExtraEgress": []
		...
		<tr>
			<td id="cnps--appTraffic"><a href="./values.yaml#L192">cnps.appTraffic</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "metrics": {
    ...
    "matchLabels": {}
		...
		<tr>
			<td id="cnps--appTraffic--egress"><a href="./values.yaml#L215">cnps.appTraffic.egress</a></td>
			<td>
object
</td>
			<td>
  ...
  "egressRules": [
    {
      ...
      "toPorts": [
		...
		<tr>
			<td id="cnps--appTraffic--egress--allow"><a href="./values.yaml#L217">cnps.appTraffic.egress.allow</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="cnps--appTraffic--egress--egressRules"><a href="./values.yaml#L220">cnps.appTraffic.egress.egressRules</a></td>
			<td>
list
</td>
			<td>
    ...
    "toPorts": [
      {
		...
		<tr>
			<td id="cnps--appTraffic--ingress"><a href="./values.yaml#L194">cnps.appTraffic.ingress</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "matchLabels": {}
		...
		<tr>
			<td id="cnps--appTraffic--ingress--allow"><a href="./values.yaml#L196">cnps.appTraffic.ingress.allow</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="cnps--appTraffic--ingress--matchLabels"><a href="./values.yaml#L201">cnps.appTraffic.ingress.matchLabels</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="cnps--appTraffic--metrics"><a href="./values.yaml#L203">cnps.appTraffic.metrics</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "matchLabels": {}
		...
		<tr>
			<td id="cnps--appTraffic--metrics--allow"><a href="./values.yaml#L207">cnps.appTraffic.metrics.allow</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="cnps--appTraffic--metrics--matchLabels"><a href="./values.yaml#L213">cnps.appTraffic.metrics.matchLabels</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="cnps--cnpgTraffic"><a href="./values.yaml#L239">cnps.cnpgTraffic</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "instanceExtraEgress": []
		...
		<tr>
			<td id="cnps--cnpgTraffic--instanceExtraEgress"><a href="./values.yaml#L257">cnps.cnpgTraffic.instanceExtraEgress</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="env"><a href="./values.yaml#L158">env</a></td>
			<td>
object
</td>
			<td>
...
""
		...
		<tr>
			<td id="hpa"><a href="./values.yaml#L308">hpa</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "targetCPUUtilizationPercentage": 70
		...
		<tr>
			<td id="hpa--enabled"><a href="./values.yaml#L310">hpa.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="hpa--maxReplicas"><a href="./values.yaml#L314">hpa.maxReplicas</a></td>
			<td>
int
</td>
			<td>
...
10
		...
		<tr>
			<td id="hpa--minReplicas"><a href="./values.yaml#L312">hpa.minReplicas</a></td>
			<td>
int
</td>
			<td>
...
2
		...
		<tr>
			<td id="hpa--targetCPUUtilizationPercentage"><a href="./values.yaml#L316">hpa.targetCPUUtilizationPercentage</a></td>
			<td>
int
</td>
			<td>
...
[]
		...
		<tr>
			<td id="libchartCnps"><a href="./values.yaml#L182">libchartCnps</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "includeCnpgPolicies": false
		...
		<tr>
			<td id="libchartCnps--enabled"><a href="./values.yaml#L184">libchartCnps.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="libchartCnps--includeCnpgPolicies"><a href="./values.yaml#L186">libchartCnps.includeCnpgPolicies</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="livenessProbe--exec--command[0]"><a href="./values.yaml#L326">livenessProbe.exec.command[0]</a></td>
			<td>
string
</td>
			<td>
...
"/bin/sh"
		...
		<tr>
			<td id="livenessProbe--exec--command[1]"><a href="./values.yaml#L326">livenessProbe.exec.command[1]</a></td>
			<td>
string
</td>
			<td>
...
"-c"
		...
		<tr>
			<td id="livenessProbe--exec--command[2]"><a href="./values.yaml#L326">livenessProbe.exec.command[2]</a></td>
			<td>
string
</td>
			<td>
...
"netbird status | grep 'NetBird IP: 100'"
		...
		<tr>
			<td id="livenessProbe--failureThreshold"><a href="./values.yaml#L327">livenessProbe.failureThreshold</a></td>
			<td>
int
</td>
			<td>
...
12
		...
		<tr>
			<td id="livenessProbe--initialDelaySeconds"><a href="./values.yaml#L329">livenessProbe.initialDelaySeconds</a></td>
			<td>
int
</td>
			<td>
...
10
		...
		<tr>
			<td id="livenessProbe--periodSeconds"><a href="./values.yaml#L328">livenessProbe.periodSeconds</a></td>
			<td>
int
</td>
			<td>
...
10
		...
		<tr>
			<td id="monitoring"><a href="./values.yaml#L280">monitoring</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "serviceMonitor": {
    ...
    "annotations": {}
		...
		<tr>
			<td id="monitoring--enabled"><a href="./values.yaml#L282">monitoring.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="monitoring--serviceMonitor"><a href="./values.yaml#L284">monitoring.serviceMonitor</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "annotations": {}
		...
		<tr>
			<td id="monitoring--serviceMonitor--additionalLabels"><a href="./values.yaml#L290">monitoring.serviceMonitor.additionalLabels</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="monitoring--serviceMonitor--annotations"><a href="./values.yaml#L287">monitoring.serviceMonitor.annotations</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="persistence"><a href="./values.yaml#L260">persistence</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "storageClass": "longhorn"
		...
		<tr>
			<td id="persistence--accessModes"><a href="./values.yaml#L270">persistence.accessModes</a></td>
			<td>
list
</td>
			<td>
...
[
  "ReadWriteOnce"
		...
		<tr>
			<td id="persistence--emptyDirSizeLimit"><a href="./values.yaml#L264">persistence.emptyDirSizeLimit</a></td>
			<td>
string
</td>
			<td>
...
"50Mi"
		...
		<tr>
			<td id="persistence--size"><a href="./values.yaml#L266">persistence.size</a></td>
			<td>
string
</td>
			<td>
...
"250Mi"
		...
		<tr>
			<td id="persistence--storageClass"><a href="./values.yaml#L268">persistence.storageClass</a></td>
			<td>
string
</td>
			<td>
...
{}
		...
		<tr>
			<td id="podSecurityContext"><a href="./values.yaml#L32">podSecurityContext</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "seccompProfile": {
    "type": "RuntimeDefault"
		...
		<tr>
			<td id="readinessProbe--exec--command[0]"><a href="./values.yaml#L332">readinessProbe.exec.command[0]</a></td>
			<td>
string
</td>
			<td>
...
"/bin/sh"
		...
		<tr>
			<td id="readinessProbe--exec--command[1]"><a href="./values.yaml#L332">readinessProbe.exec.command[1]</a></td>
			<td>
string
</td>
			<td>
...
"-c"
		...
		<tr>
			<td id="readinessProbe--exec--command[2]"><a href="./values.yaml#L332">readinessProbe.exec.command[2]</a></td>
			<td>
string
</td>
			<td>
...
"netbird status | grep 'NetBird IP: 100'"
		...
		<tr>
			<td id="readinessProbe--failureThreshold"><a href="./values.yaml#L333">readinessProbe.failureThreshold</a></td>
			<td>
int
</td>
			<td>
...
6
		...
		<tr>
			<td id="readinessProbe--initialDelaySeconds"><a href="./values.yaml#L335">readinessProbe.initialDelaySeconds</a></td>
			<td>
int
</td>
			<td>
...
10
		...
		<tr>
			<td id="readinessProbe--periodSeconds"><a href="./values.yaml#L334">readinessProbe.periodSeconds</a></td>
			<td>
int
</td>
			<td>
...
1
		...
		<tr>
			<td id="resources"><a href="./values.yaml#L293">resources</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "requests": {
    ...
    "memory": "128Mi"
		...
		<tr>
			<td id="resources--limits"><a href="./values.yaml#L301">resources.limits</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "memory": "256Mi"
		...
		<tr>
			<td id="resources--limits--cpu"><a href="./values.yaml#L303">resources.limits.cpu</a></td>
			<td>
string
</td>
			<td>
...
"100m"
		...
		<tr>
			<td id="resources--limits--memory"><a href="./values.yaml#L305">resources.limits.memory</a></td>
			<td>
string
</td>
			<td>
...
"256Mi"
		...
		<tr>
			<td id="resources--requests"><a href="./values.yaml#L295">resources.requests</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "memory": "128Mi"
		...
		<tr>
			<td id="resources--requests--cpu"><a href="./values.yaml#L297">resources.requests.cpu</a></td>
			<td>
string
</td>
			<td>
...
"50m"
		...
		<tr>
			<td id="resources--requests--memory"><a href="./values.yaml#L299">resources.requests.memory</a></td>
			<td>
string
</td>
			<td>
...
"128Mi"
		...
		<tr>
			<td id="rootPodSecurityContext"><a href="./values.yaml#L53">rootPodSecurityContext</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "seccompProfile": {
    "type": "RuntimeDefault"
			...
			<td>Pod security context (root) @description podSecurityContext when running netbird with root context. Note: Requires agent.caEnableRootless: false to get applied.</td>
		</tr>
		<tr>
			<td id="rootSecurityContext"><a href="./values.yaml#L61">rootSecurityContext</a></td>
			<td>
object
</td>
			<td>
  ...
  "sysctls": [
    {
      ...
      "value": "1"
			...
			<td>Container security context (root) @description securityContext when running netbird with root context. Note: Requires agent.caEnableRootless: false to get applied.</td>
		</tr>
		<tr>
			<td id="runtimeClass"><a href="./values.yaml#L90">runtimeClass</a></td>
			<td>
object
</td>
			<td>
...
<i>Source and more informations: https://kubernetes.io/docs/concepts/containers/runtime-class/ </i>
		...
		<tr>
			<td id="runtimeClass--jobs"><a href="./values.yaml#L94">runtimeClass.jobs</a></td>
			<td>
...
""
		...
		<tr>
			<td id="runtimeClass--pods"><a href="./values.yaml#L92">runtimeClass.pods</a></td>
			<td>
<a href="#stringruntimeclassname" title="Click to get details">string/runtimeClassName</a>
</td>
			<td>
...
""
		...
		<tr>
			<td id="runtimeClass--tests"><a href="./values.yaml#L96">runtimeClass.tests</a></td>
			<td>
<a href="#stringruntimeclassname" title="Click to get details">string/runtimeClassName</a>
</td>
			<td>
...
""
		...
		<tr>
			<td id="securityContext"><a href="./values.yaml#L42">securityContext</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "runAsNonRoot": true
			...
			<td>Container security context (rootless) @description securityContext when running netbird with rootless (netstack) context. Note: Requires agent.caEnableRootless: true to get applied.</td>
		</tr>
		<tr>
			<td id="service"><a href="./values.yaml#L99">service</a></td>
			<td>
object
</td>
			<td>
...
""
		...
		<tr>
			<td id="startupProbe"><a href="./values.yaml#L319">startupProbe</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="tolerations"><a href="./values.yaml#L341">tolerations</a></td>
			<td>
list
</td>
			<td>
