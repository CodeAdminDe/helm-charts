...
![Version: 0.10.1](https://img.shields.io/badge/Version-0.10.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.65.1](https://img.shields.io/badge/AppVersion-0.65.1-informational?style=flat-square)
...
{}
		...
		<tr>
			<td id="cnps--cnpgTraffic"><a href="./values.yaml#L242">cnps.cnpgTraffic</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "instanceExtraEgress": []
		...
		<tr>
			<td id="cnps--cnpgTraffic--instanceExtraEgress"><a href="./values.yaml#L260">cnps.cnpgTraffic.instanceExtraEgress</a></td>
			<td>
list
</td>
			<td>
...
""
		...
		<tr>
			<td id="hpa"><a href="./values.yaml#L311">hpa</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "targetCPUUtilizationPercentage": 70
		...
		<tr>
			<td id="hpa--enabled"><a href="./values.yaml#L313">hpa.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="hpa--maxReplicas"><a href="./values.yaml#L317">hpa.maxReplicas</a></td>
			<td>
int
</td>
			<td>
...
10
		...
		<tr>
			<td id="hpa--minReplicas"><a href="./values.yaml#L315">hpa.minReplicas</a></td>
			<td>
int
</td>
			<td>
...
2
		...
		<tr>
			<td id="hpa--targetCPUUtilizationPercentage"><a href="./values.yaml#L319">hpa.targetCPUUtilizationPercentage</a></td>
			<td>
int
</td>
			<td>
...
false
		...
		<tr>
			<td id="livenessProbe--exec--command[0]"><a href="./values.yaml#L329">livenessProbe.exec.command[0]</a></td>
			<td>
string
</td>
			<td>
...
"/bin/sh"
		...
		<tr>
			<td id="livenessProbe--exec--command[1]"><a href="./values.yaml#L329">livenessProbe.exec.command[1]</a></td>
			<td>
string
</td>
			<td>
...
"-c"
		...
		<tr>
			<td id="livenessProbe--exec--command[2]"><a href="./values.yaml#L329">livenessProbe.exec.command[2]</a></td>
			<td>
string
</td>
			<td>
...
"netbird status | grep 'NetBird IP: 100'"
		...
		<tr>
			<td id="livenessProbe--failureThreshold"><a href="./values.yaml#L330">livenessProbe.failureThreshold</a></td>
			<td>
int
</td>
			<td>
...
12
		...
		<tr>
			<td id="livenessProbe--initialDelaySeconds"><a href="./values.yaml#L332">livenessProbe.initialDelaySeconds</a></td>
			<td>
int
</td>
			<td>
...
10
		...
		<tr>
			<td id="livenessProbe--periodSeconds"><a href="./values.yaml#L331">livenessProbe.periodSeconds</a></td>
			<td>
int
</td>
			<td>
...
<pre lang="json">
{
  ...
  "serviceMonitor": {
    ...
    "annotations": {}
		...
		<tr>
			<td id="monitoring--enabled"><a href="./values.yaml#L285">monitoring.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="monitoring--serviceMonitor"><a href="./values.yaml#L287">monitoring.serviceMonitor</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "annotations": {}
		...
		<tr>
			<td id="monitoring--serviceMonitor--additionalLabels"><a href="./values.yaml#L293">monitoring.serviceMonitor.additionalLabels</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="monitoring--serviceMonitor--annotations"><a href="./values.yaml#L290">monitoring.serviceMonitor.annotations</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="persistence"><a href="./values.yaml#L263">persistence</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "storageClass": "longhorn"
		...
		<tr>
			<td id="persistence--accessModes"><a href="./values.yaml#L273">persistence.accessModes</a></td>
			<td>
list
</td>
			<td>
...
[
  "ReadWriteOnce"
		...
		<tr>
			<td id="persistence--emptyDirSizeLimit"><a href="./values.yaml#L267">persistence.emptyDirSizeLimit</a></td>
			<td>
string
</td>
			<td>
...
"50Mi"
		...
		<tr>
			<td id="persistence--size"><a href="./values.yaml#L269">persistence.size</a></td>
			<td>
string
</td>
			<td>
...
"250Mi"
		...
		<tr>
			<td id="persistence--storageClass"><a href="./values.yaml#L271">persistence.storageClass</a></td>
			<td>
string
</td>
			<td>
...
1
		...
		<tr>
			<td id="resources"><a href="./values.yaml#L296">resources</a></td>
			<td>
object
</td>
			<td>
...
"256Mi"
		...
		<tr>
			<td id="resources--requests"><a href="./values.yaml#L298">resources.requests</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "memory": "128Mi"
		...
		<tr>
			<td id="resources--requests--cpu"><a href="./values.yaml#L300">resources.requests.cpu</a></td>
			<td>
string
</td>
			<td>
...
"50m"
		...
		<tr>
			<td id="resources--requests--memory"><a href="./values.yaml#L302">resources.requests.memory</a></td>
			<td>
string
</td>
			<td>
