...
helm.sh/chart: {{ include "netbird-agent.chart" . }}
...
app.kubernetes.io/name: {{ include "netbird-agent.name" . }}
...
{{- default (include "netbird-agent.fullname" .) .Values.serviceAccount.name }}
{{- else }}
