...
<pre lang="json">
{
  ...
  "extraRules": []
		...
		<tr>
			<td id="egress--backends"><a href="./values.yaml#L98">egress.backends</a></td>
			<td>
list
</td>
			<td>
...
true
		...
		<tr>
			<td id="egress--controlPlane--ports"><a href="./values.yaml#L77">egress.controlPlane.ports</a></td>
			<td>
list
</td>
			<td>
...
[
  ...
  18002
		...
		<tr>
			<td id="egress--controlPlane--toEndpoints"><a href="./values.yaml#L71">egress.controlPlane.toEndpoints</a></td>
			<td>
list
</td>
			<td>
...
[
  {
    "matchLabels": {
      ...
      "io.kubernetes.pod.namespace": "envoy-gateway-system"
			...
			<td>Endpoint selectors for the Envoy Gateway control plane.</td>
		</tr>
		<tr>
			<td id="egress--dns--enabled"><a href="./values.yaml#L84">egress.dns.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="egress--external"><a href="./values.yaml#L110">egress.external</a></td>
			<td>
list
</td>
			<td>
...
```</td>
		...
		<tr>
			<td id="egress--extraRules"><a href="./values.yaml#L113">egress.extraRules</a></td>
			<td>
list
</td>
			<td>
...
false
		...
		<tr>
			<td id="podSecurityContext"><a href="./values.yaml#L120">podSecurityContext</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "tests": ""
		...
		<tr>
			<td id="securityContext"><a href="./values.yaml#L123">securityContext</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "matchLabels": {
    ...
    "gateway.envoyproxy.io/owning-gateway-name": "example"
			...
			<td>Selector for the EnvoyProxy dataplane pods this release should govern. @description Must be narrow and explicit. The chart never uses a broad empty selector for dataplane policies.</td>
		</tr>
	</tbody>
</table>
