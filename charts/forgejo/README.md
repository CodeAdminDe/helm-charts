...
true
		...
		<tr>
			<td id="cnps--appTraffic--egress--extraRules"><a href="./values.yaml#L515">cnps.appTraffic.egress.extraRules</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="cnps--appTraffic--egress--toPorts"><a href="./values.yaml#L507">cnps.appTraffic.egress.toPorts</a></td>
			<td>
list
</td>
			<td>
...
[
  ...
  },
  {
    ...
    "protocol": "TCP"
			...
			<td>Additional egress ports for the general egress rules. @description When using external PostgreSQL together with `libchartCnps.enabled=true`, explicitly add the database port here and define a matching `toEndpoints`, `toFQDNs`, `toEntities`, or `extraRules` target for that database traffic.</td>
		</tr>
		<tr>
...
<pre lang="json">
{
  ...
  "seccompProfile": {
    "type": "RuntimeDefault"
		...
		<tr>
			<td id="securityContext--capabilities--add"><a href="./values.yaml#L173">securityContext.capabilities.add</a></td>
			<td>
list
</td>
			<td>
...
null
		...
		<tr>
			<td id="test"><a href="./values.yaml#L518">test</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "image": {
    ...
    "tag": "1.37"
		...
		<tr>
			<td id="test--enabled"><a href="./values.yaml#L520">test.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="test--image--pullPolicy"><a href="./values.yaml#L527">test.image.pullPolicy</a></td>
			<td>
string
</td>
			<td>
...
"IfNotPresent"
		...
		<tr>
			<td id="test--image--repository"><a href="./values.yaml#L523">test.image.repository</a></td>
			<td>
string
</td>
			<td>
...
"busybox"
		...
		<tr>
			<td id="test--image--tag"><a href="./values.yaml#L525">test.image.tag</a></td>
			<td>
string
</td>
			<td>
...
* The chart defaults to the official rootless Forgejo image. On some CRI-O based clusters, Git-over-SSH may additionally require `securityContext.capabilities.add: [SYS_CHROOT]` as documented by Forgejo.
