...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.30.3](https://img.shields.io/badge/AppVersion-v2.30.3-informational?style=flat-square)
...
<table height="800px" >
	...
	<tbody>
		<tr>
			<td id="additionalEnvSecrets"><a href="./values.yaml#L292">additionalEnvSecrets</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="affinity"><a href="./values.yaml#L352">affinity</a></td>
			<td>
object
</td>
			<td>
...
true
		...
		<tr>
			<td id="args"><a href="./values.yaml#L276">args</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="autoscaling"><a href="./values.yaml#L249">autoscaling</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "targetCPUUtilizationPercentage": 80
		...
		<tr>
			<td id="cnps"><a href="./values.yaml#L306">cnps</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "cnpgTraffic": {
    "instanceExtraEgress": []
		...
		<tr>
			<td id="cnps--appTraffic--egress--allow"><a href="./values.yaml#L320">cnps.appTraffic.egress.allow</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="cnps--appTraffic--egress--extraRules"><a href="./values.yaml#L337">cnps.appTraffic.egress.extraRules</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="cnps--appTraffic--egress--toEndpoints"><a href="./values.yaml#L322">cnps.appTraffic.egress.toEndpoints</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="cnps--appTraffic--egress--toEntities"><a href="./values.yaml#L327">cnps.appTraffic.egress.toEntities</a></td>
			<td>
list
</td>
			<td>
...
[
  ...
  "world"
		...
		<tr>
			<td id="cnps--appTraffic--egress--toFQDNs"><a href="./values.yaml#L324">cnps.appTraffic.egress.toFQDNs</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="cnps--appTraffic--egress--toPorts"><a href="./values.yaml#L331">cnps.appTraffic.egress.toPorts</a></td>
			<td>
list
</td>
			<td>
...
[
  ...
  },
  {
    ...
    "protocol": "TCP"
		...
		<tr>
			<td id="cnps--appTraffic--ingress--allow"><a href="./values.yaml#L313">cnps.appTraffic.ingress.allow</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="cnps--appTraffic--ingress--fromEndpoints"><a href="./values.yaml#L315">cnps.appTraffic.ingress.fromEndpoints</a></td>
			<td>
list
</td>
			<td>
...
[]
			...
			<td>Explicit endpoint selectors allowed to reach the Coder webserver.</td>
		</tr>
		<tr>
			<td id="cnps--appTraffic--ingress--fromEntities"><a href="./values.yaml#L317">cnps.appTraffic.ingress.fromEntities</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="cnps--cnpgTraffic"><a href="./values.yaml#L308">cnps.cnpgTraffic</a></td>
			<td>
object
</td>
			<td>
...
""
		...
		<tr>
			<td id="command"><a href="./values.yaml#L273">command</a></td>
			<td>
list
</td>
			<td>
...
"uri"
		...
		<tr>
			<td id="envFromConfigMaps"><a href="./values.yaml#L285">envFromConfigMaps</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="envFromSecrets"><a href="./values.yaml#L282">envFromSecrets</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="extraEnv"><a href="./values.yaml#L288">extraEnv</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="extraVolumeMounts"><a href="./values.yaml#L298">extraVolumeMounts</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="extraVolumes"><a href="./values.yaml#L295">extraVolumes</a></td>
			<td>
list
</td>
			<td>
...
""
		...
		<tr>
			<td id="initContainers"><a href="./values.yaml#L279">initContainers</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="libchartCnps"><a href="./values.yaml#L301">libchartCnps</a></td>
			<td>
object
</td>
			<td>
...
""
		...
		<tr>
			<td id="nodeSelector"><a href="./values.yaml#L346">nodeSelector</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="podAnnotations"><a href="./values.yaml#L340">podAnnotations</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="podDisruptionBudget"><a href="./values.yaml#L256">podDisruptionBudget</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "minAvailable": 1
		...
		<tr>
			<td id="podDisruptionBudget--enabled"><a href="./values.yaml#L258">podDisruptionBudget.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="podDisruptionBudget--minAvailable"><a href="./values.yaml#L260">podDisruptionBudget.minAvailable</a></td>
			<td>
int
</td>
			<td>
...
1
		...
		<tr>
			<td id="podLabels"><a href="./values.yaml#L343">podLabels</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "fsGroup": 1000
		...
		<tr>
			<td id="priorityClassName"><a href="./values.yaml#L270">priorityClassName</a></td>
			<td>
string
</td>
			<td>
...
{}
		...
		<tr>
			<td id="runtimeClass"><a href="./values.yaml#L263">runtimeClass</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "tests": ""
		...
		<tr>
			<td id="runtimeClass--pods"><a href="./values.yaml#L265">runtimeClass.pods</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="runtimeClass--tests"><a href="./values.yaml#L267">runtimeClass.tests</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="tolerations"><a href="./values.yaml#L349">tolerations</a></td>
			<td>
list
</td>
			<td>
