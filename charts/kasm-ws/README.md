...
![Version: 0.1.1](https://img.shields.io/badge/Version-0.1.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.18.1](https://img.shields.io/badge/AppVersion-1.18.1-informational?style=flat-square)
...
{}
		...
		<tr>
			<td id="annotations--certSecret"><a href="./values.yaml#L609">annotations.certSecret</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="annotations--configMap"><a href="./values.yaml#L611">annotations.configMap</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="annotations--cron"><a href="./values.yaml#L613">annotations.cron</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="annotations--cronPod"><a href="./values.yaml#L615">annotations.cronPod</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="annotations--deployment"><a href="./values.yaml#L617">annotations.deployment</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="annotations--pod"><a href="./values.yaml#L619">annotations.pod</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="annotations--pvc"><a href="./values.yaml#L621">annotations.pvc</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="annotations--secret"><a href="./values.yaml#L625">annotations.secret</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="annotations--service"><a href="./values.yaml#L623">annotations.service</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="annotations--statefulSet"><a href="./values.yaml#L627">annotations.statefulSet</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="applyHealthChecks"><a href="./values.yaml#L576">applyHealthChecks</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="applySecurity"><a href="./values.yaml#L572">applySecurity</a></td>
			<td>
bool
</td>
			<td>
...
"cluster.local"
		...
		<tr>
			<td id="cnps"><a href="./values.yaml#L492">cnps</a></td>
			<td>
object
</td>
			<td>
  ...
  "workspaceTraffic": {
    ...
    "podSelector": {
      "matchLabels": {}
		...
		<tr>
			<td id="cnps--appTraffic--egress--allow"><a href="./values.yaml#L508">cnps.appTraffic.egress.allow</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="cnps--appTraffic--egress--egressRules"><a href="./values.yaml#L511">cnps.appTraffic.egress.egressRules</a></td>
			<td>
list
</td>
			<td>
    ...
    "toPorts": [
      {
		...
		<tr>
			<td id="cnps--appTraffic--ingress--allow"><a href="./values.yaml#L496">cnps.appTraffic.ingress.allow</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="cnps--appTraffic--ingress--fromEntities"><a href="./values.yaml#L504">cnps.appTraffic.ingress.fromEntities</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="cnps--appTraffic--ingress--matchLabels"><a href="./values.yaml#L501">cnps.appTraffic.ingress.matchLabels</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="cnps--workspaceTraffic"><a href="./values.yaml#L521">cnps.workspaceTraffic</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "podSelector": {
    "matchLabels": {}
		...
		<tr>
			<td id="cnps--workspaceTraffic--egress"><a href="./values.yaml#L536">cnps.workspaceTraffic.egress</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "privateCidrs": [
    ...
    "::1/128"
		...
		<tr>
			<td id="cnps--workspaceTraffic--egress--allow"><a href="./values.yaml#L538">cnps.workspaceTraffic.egress.allow</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="cnps--workspaceTraffic--egress--denyPrivateCidrs"><a href="./values.yaml#L557">cnps.workspaceTraffic.egress.denyPrivateCidrs</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="cnps--workspaceTraffic--egress--egressRules"><a href="./values.yaml#L540">cnps.workspaceTraffic.egress.egressRules</a></td>
			<td>
list
</td>
			<td>
  ...
  },
  {
    "toEntities": [
      "world"
		...
		<tr>
			<td id="cnps--workspaceTraffic--egress--privateCidrs"><a href="./values.yaml#L559">cnps.workspaceTraffic.egress.privateCidrs</a></td>
			<td>
list
</td>
			<td>
...
[
  ...
  "::1/128"
		...
		<tr>
			<td id="cnps--workspaceTraffic--enabled"><a href="./values.yaml#L523">cnps.workspaceTraffic.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="cnps--workspaceTraffic--ingress"><a href="./values.yaml#L531">cnps.workspaceTraffic.ingress</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "allowFromSameNamespace": true
		...
		<tr>
			<td id="cnps--workspaceTraffic--ingress--allowFromSameNamespace"><a href="./values.yaml#L534">cnps.workspaceTraffic.ingress.allowFromSameNamespace</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="cnps--workspaceTraffic--namespace"><a href="./values.yaml#L525">cnps.workspaceTraffic.namespace</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="cnps--workspaceTraffic--podSelector"><a href="./values.yaml#L528">cnps.workspaceTraffic.podSelector</a></td>
			<td>
object
</td>
			<td>
...
"small"
		...
		<tr>
			<td id="extraLabels--certSecret"><a href="./values.yaml#L635">extraLabels.certSecret</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="extraLabels--cron"><a href="./values.yaml#L651">extraLabels.cron</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="extraLabels--cronPod"><a href="./values.yaml#L653">extraLabels.cronPod</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="extraLabels--deployment"><a href="./values.yaml#L639">extraLabels.deployment</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="extraLabels--job"><a href="./values.yaml#L647">extraLabels.job</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="extraLabels--jobPod"><a href="./values.yaml#L649">extraLabels.jobPod</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="extraLabels--pod"><a href="./values.yaml#L641">extraLabels.pod</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="extraLabels--pvc"><a href="./values.yaml#L655">extraLabels.pvc</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="extraLabels--secret"><a href="./values.yaml#L643">extraLabels.secret</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="extraLabels--service"><a href="./values.yaml#L645">extraLabels.service</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="extraLabels--statefulSet"><a href="./values.yaml#L657">extraLabels.statefulSet</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="extraObjects"><a href="./values.yaml#L662">extraObjects</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="labels"><a href="./values.yaml#L601">labels</a></td>
			<td>
object
</td>
			<td>
...
false
		...
		<tr>
			<td id="libchartCnps--includeCnpgPolicies"><a href="./values.yaml#L488">libchartCnps.includeCnpgPolicies</a></td>
			<td>
bool
</td>
			<td>
...
{}
		...
		<tr>
			<td id="rbac--serviceAccount--automountServiceAccountToken"><a href="./values.yaml#L480">rbac.serviceAccount.automountServiceAccountToken</a></td>
			<td>
bool
</td>
			<td>
...
false
			...
			<td>Automatically mount ServiceAccount API credentials into manager pods. @description Defaults to false for least-privilege. Effective mounting in manager pods only becomes true when this is true AND either rbac.create=true or a non-default serviceAccount name is configured.</td>
		</tr>
		<tr>
...
""
		...
		<tr>
			<td id="restartPolicy"><a href="./values.yaml#L597">restartPolicy</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="securityCompatibility"><a href="./values.yaml#L580">securityCompatibility</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "rootInitContainers": {
    ...
    "rdpHttpsGateway": false
		...
		<tr>
			<td id="securityCompatibility--rootInitContainers--db"><a href="./values.yaml#L591">securityCompatibility.rootInitContainers.db</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="securityCompatibility--rootInitContainers--dbBackupCron"><a href="./values.yaml#L593">securityCompatibility.rootInitContainers.dbBackupCron</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="securityCompatibility--rootInitContainers--guac"><a href="./values.yaml#L585">securityCompatibility.rootInitContainers.guac</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="securityCompatibility--rootInitContainers--proxy"><a href="./values.yaml#L583">securityCompatibility.rootInitContainers.proxy</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="securityCompatibility--rootInitContainers--rdpGateway"><a href="./values.yaml#L587">securityCompatibility.rootInitContainers.rdpGateway</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="securityCompatibility--rootInitContainers--rdpHttpsGateway"><a href="./values.yaml#L589">securityCompatibility.rootInitContainers.rdpHttpsGateway</a></td>
			<td>
bool
</td>
			<td>
