...
null
		...
		<tr>
			<td id="affinity"><a href="./values.yaml#L238">affinity</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "targetCPUUtilizationPercentage": 80
		...
		<tr>
			<td id="env"><a href="./values.yaml#L130">env</a></td>
			<td>
string
</td>
			<td>
  ...
  "tls": [
    {
      ...
      "secretName": ""
		...
		<tr>
			<td id="ingress--tls[0]--secretName"><a href="./values.yaml#L182">ingress.tls[0].secretName</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="livenessProbe"><a href="./values.yaml#L198">livenessProbe</a></td>
			<td>
object
</td>
			<td>
...
""
		...
		<tr>
			<td id="nodeSelector"><a href="./values.yaml#L234">nodeSelector</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "logLevel": "INFO"
		...
		<tr>
			<td id="persistence"><a href="./values.yaml#L109">persistence</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "storageClass": ""
		...
		<tr>
			<td id="persistence--accessModes"><a href="./values.yaml#L122">persistence.accessModes</a></td>
			<td>
list
</td>
			<td>
...
[
  "ReadWriteOnce"
		...
		<tr>
			<td id="persistence--cacheDirHomeSizeLimit"><a href="./values.yaml#L116">persistence.cacheDirHomeSizeLimit</a></td>
			<td>
string
</td>
			<td>
...
"2Mi"
		...
		<tr>
			<td id="persistence--emptyDirSizeLimit"><a href="./values.yaml#L114">persistence.emptyDirSizeLimit</a></td>
			<td>
string
</td>
			<td>
...
"500Mi"
		...
		<tr>
			<td id="persistence--enabled"><a href="./values.yaml#L112">persistence.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="persistence--size"><a href="./values.yaml#L118">persistence.size</a></td>
			<td>
string
</td>
			<td>
...
"50Gi"
		...
		<tr>
			<td id="persistence--storageClass"><a href="./values.yaml#L120">persistence.storageClass</a></td>
			<td>
string
</td>
			<td>
...
<pre lang="json">
{
  "fsGroup": 1000
		...
		<tr>
			<td id="prePullModelList"><a href="./values.yaml#L98">prePullModelList</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="readinessProbe--failureThreshold"><a href="./values.yaml#L209">readinessProbe.failureThreshold</a></td>
			<td>
int
</td>
			<td>
...
3
		...
		<tr>
			<td id="readinessProbe--httpGet--path"><a href="./values.yaml#L207">readinessProbe.httpGet.path</a></td>
			<td>
string
</td>
			<td>
...
"/"
		...
		<tr>
			<td id="readinessProbe--httpGet--port"><a href="./values.yaml#L208">readinessProbe.httpGet.port</a></td>
			<td>
string
</td>
			<td>
...
"http"
		...
		<tr>
			<td id="readinessProbe--initialDelaySeconds"><a href="./values.yaml#L211">readinessProbe.initialDelaySeconds</a></td>
			<td>
int
</td>
			<td>
...
30
		...
		<tr>
			<td id="readinessProbe--periodSeconds"><a href="./values.yaml#L210">readinessProbe.periodSeconds</a></td>
			<td>
int
</td>
			<td>
...
[]
		...
		<tr>
			<td id="volumeMounts"><a href="./values.yaml#L229">volumeMounts</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="volumes"><a href="./values.yaml#L222">volumes</a></td>
			<td>
list
</td>
			<td>
