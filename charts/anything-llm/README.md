...
<table height="800px" >
	...
	<tbody>
		<tr>
			<td id="additionalEnvSecrets"><a href="./values.yaml#L267">additionalEnvSecrets</a></td>
			<td>
object
</td>
			<td>
...
```</td>
		...
		<tr>
			<td id="affinity"><a href="./values.yaml#L368">affinity</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="anythingllm"><a href="./values.yaml#L154">anythingllm</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "whisperProvider": "local"
		...
		<tr>
			<td id="anythingllm--chromiumArgs"><a href="./values.yaml#L169">anythingllm.chromiumArgs</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="anythingllm--collectorAllowAnyIp"><a href="./values.yaml#L173">anythingllm.collectorAllowAnyIp</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="anythingllm--disableSwaggerDocs"><a href="./values.yaml#L171">anythingllm.disableSwaggerDocs</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="anythingllm--disableTelemetry"><a href="./values.yaml#L160">anythingllm.disableTelemetry</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="anythingllm--nodeEnv"><a href="./values.yaml#L158">anythingllm.nodeEnv</a></td>
			<td>
string
</td>
			<td>
...
"production"
		...
		<tr>
			<td id="anythingllm--security"><a href="./values.yaml#L175">anythingllm.security</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "enableSysAdminCapability": false
		...
		<tr>
			<td id="anythingllm--security--enableSysAdminCapability"><a href="./values.yaml#L178">anythingllm.security.enableSysAdminCapability</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="anythingllm--storageDir"><a href="./values.yaml#L156">anythingllm.storageDir</a></td>
			<td>
string
</td>
			<td>
...
"/app/server/storage"
		...
		<tr>
			<td id="anythingllm--ttsProvider"><a href="./values.yaml#L166">anythingllm.ttsProvider</a></td>
			<td>
string
</td>
			<td>
...
"native"
		...
		<tr>
			<td id="anythingllm--vectorDb"><a href="./values.yaml#L162">anythingllm.vectorDb</a></td>
			<td>
string
</td>
			<td>
...
"lancedb"
		...
		<tr>
			<td id="anythingllm--whisperProvider"><a href="./values.yaml#L164">anythingllm.whisperProvider</a></td>
			<td>
string
</td>
			<td>
...
"local"
		...
		<tr>
			<td id="applyHealthChecks"><a href="./values.yaml#L282">applyHealthChecks</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="args"><a href="./values.yaml#L247">args</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="auth"><a href="./values.yaml#L199">auth</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "enabled": false
		...
		<tr>
			<td id="auth--enabled"><a href="./values.yaml#L201">auth.enabled</a></td>
			<td>
bool
</td>
			<td>
...
80
		...
		<tr>
			<td id="cnps"><a href="./values.yaml#L378">cnps</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "cnpgTraffic": {
    "instanceExtraEgress": []
		...
		<tr>
			<td id="cnps--appTraffic--egress--allow"><a href="./values.yaml#L394">cnps.appTraffic.egress.allow</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="cnps--appTraffic--egress--toEntities"><a href="./values.yaml#L396">cnps.appTraffic.egress.toEntities</a></td>
			<td>
list
</td>
			<td>
...
[
  ...
  "world"
		...
		<tr>
			<td id="cnps--appTraffic--egress--toPorts"><a href="./values.yaml#L401">cnps.appTraffic.egress.toPorts</a></td>
			<td>
list
</td>
			<td>
...
[
  ...
  },
  {
    ...
    "protocol": "TCP"
		...
		<tr>
			<td id="cnps--appTraffic--ingress--allow"><a href="./values.yaml#L386">cnps.appTraffic.ingress.allow</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="cnps--appTraffic--ingress--fromEndpoints"><a href="./values.yaml#L389">cnps.appTraffic.ingress.fromEndpoints</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="cnps--appTraffic--ingress--fromEntities"><a href="./values.yaml#L391">cnps.appTraffic.ingress.fromEntities</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="cnps--cnpgTraffic"><a href="./values.yaml#L380">cnps.cnpgTraffic</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "instanceExtraEgress": []
		...
		<tr>
			<td id="cnps--cnpgTraffic--instanceExtraEgress"><a href="./values.yaml#L382">cnps.cnpgTraffic.instanceExtraEgress</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="command"><a href="./values.yaml#L244">command</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="database"><a href="./values.yaml#L204">database</a></td>
			<td>
object
</td>
			<td>
  ...
  "useCnpgCluster": {
    ...
    "secretKeys": {
      ...
      "username": "user"
		...
		<tr>
			<td id="database--mode"><a href="./values.yaml#L207">database.mode</a></td>
			<td>
string
</td>
			<td>
...
"sqlite"
		...
		<tr>
			<td id="database--postgres--database"><a href="./values.yaml#L214">database.postgres.database</a></td>
			<td>
string
</td>
			<td>
...
"anythingllm"
		...
		<tr>
			<td id="database--postgres--host"><a href="./values.yaml#L210">database.postgres.host</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="database--postgres--passwordSecret--key"><a href="./values.yaml#L223">database.postgres.passwordSecret.key</a></td>
			<td>
string
</td>
			<td>
...
"password"
		...
		<tr>
			<td id="database--postgres--passwordSecret--name"><a href="./values.yaml#L221">database.postgres.passwordSecret.name</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="database--postgres--pgVectorTable"><a href="./values.yaml#L225">database.postgres.pgVectorTable</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="database--postgres--port"><a href="./values.yaml#L212">database.postgres.port</a></td>
			<td>
int
</td>
			<td>
...
5432
		...
		<tr>
			<td id="database--postgres--ssl"><a href="./values.yaml#L218">database.postgres.ssl</a></td>
			<td>
string
</td>
			<td>
...
"require"
		...
		<tr>
			<td id="database--postgres--user"><a href="./values.yaml#L216">database.postgres.user</a></td>
			<td>
string
</td>
			<td>
...
"anythingllm"
		...
		<tr>
			<td id="database--useCnpgCluster--appConnectionSecretName"><a href="./values.yaml#L234">database.useCnpgCluster.appConnectionSecretName</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="database--useCnpgCluster--clusterName"><a href="./values.yaml#L230">database.useCnpgCluster.clusterName</a></td>
			<td>
string
</td>
			<td>
...
"cnpg-cluster"
		...
		<tr>
			<td id="database--useCnpgCluster--enabled"><a href="./values.yaml#L228">database.useCnpgCluster.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="database--useCnpgCluster--port"><a href="./values.yaml#L232">database.useCnpgCluster.port</a></td>
			<td>
int
</td>
			<td>
...
5432
		...
		<tr>
			<td id="database--useCnpgCluster--secretKeys--database"><a href="./values.yaml#L237">database.useCnpgCluster.secretKeys.database</a></td>
			<td>
string
</td>
			<td>
...
"dbname"
		...
		<tr>
			<td id="database--useCnpgCluster--secretKeys--password"><a href="./values.yaml#L241">database.useCnpgCluster.secretKeys.password</a></td>
			<td>
string
</td>
			<td>
...
"password"
		...
		<tr>
			<td id="database--useCnpgCluster--secretKeys--username"><a href="./values.yaml#L239">database.useCnpgCluster.secretKeys.username</a></td>
			<td>
string
</td>
			<td>
...
"user"
		...
		<tr>
			<td id="envFromConfigMaps"><a href="./values.yaml#L273">envFromConfigMaps</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="envFromSecrets"><a href="./values.yaml#L270">envFromSecrets</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="extraEnv"><a href="./values.yaml#L250">extraEnv</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="extraVolumeMounts"><a href="./values.yaml#L279">extraVolumeMounts</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="extraVolumes"><a href="./values.yaml#L276">extraVolumes</a></td>
			<td>
list
</td>
			<td>
  ...
  "parentRefs": [
    {
      ...
      "sectionName": "http"
		...
		<tr>
			<td id="gatewayApi--annotations"><a href="./values.yaml#L94">gatewayApi.annotations</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="gatewayApi--backendRefs"><a href="./values.yaml#L113">gatewayApi.backendRefs</a></td>
			<td>
list
</td>
			<td>
...
false
		...
		<tr>
			<td id="gatewayApi--filters"><a href="./values.yaml#L111">gatewayApi.filters</a></td>
			<td>
list
</td>
			<td>
...
[]
		...
		<tr>
			<td id="gatewayApi--hostnames"><a href="./values.yaml#L103">gatewayApi.hostnames</a></td>
			<td>
list
</td>
			<td>
...
[
  "anything-llm.example.com"
		...
		<tr>
			<td id="gatewayApi--labels"><a href="./values.yaml#L96">gatewayApi.labels</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="gatewayApi--matches"><a href="./values.yaml#L106">gatewayApi.matches</a></td>
			<td>
list
</td>
			<td>
...
[
  {
    "path": {
      ...
      "value": "/"
		...
		<tr>
			<td id="gatewayApi--parentRefs"><a href="./values.yaml#L98">gatewayApi.parentRefs</a></td>
			<td>
list
</td>
			<td>
...
"pg"
			...
			<td>PostgreSQL runtime image tag. @description Official docs currently use `mintplexlabs/anythingllm:pg` for PostgreSQL mode.</td>
		</tr>
		<tr>
...
[]
		...
		<tr>
			<td id="libchartCnps"><a href="./values.yaml#L371">libchartCnps</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "includeCnpgPolicies": false
		...
		<tr>
			<td id="libchartCnps--enabled"><a href="./values.yaml#L373">libchartCnps.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="libchartCnps--includeCnpgPolicies"><a href="./values.yaml#L375">libchartCnps.includeCnpgPolicies</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="livenessProbe"><a href="./values.yaml#L285">livenessProbe</a></td>
			<td>
object
</td>
			<td>
...
""
		...
		<tr>
			<td id="nodeSelector"><a href="./values.yaml#L362">nodeSelector</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="persistence"><a href="./values.yaml#L123">persistence</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "volumeName": ""
		...
		<tr>
			<td id="persistence--accessModes"><a href="./values.yaml#L135">persistence.accessModes</a></td>
			<td>
list
</td>
			<td>
...
[
  "ReadWriteOnce"
		...
		<tr>
			<td id="persistence--annotations"><a href="./values.yaml#L138">persistence.annotations</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="persistence--enabled"><a href="./values.yaml#L125">persistence.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="persistence--existingClaim"><a href="./values.yaml#L129">persistence.existingClaim</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="persistence--mountPath"><a href="./values.yaml#L142">persistence.mountPath</a></td>
			<td>
string
</td>
			<td>
...
"/app/server/storage"
		...
		<tr>
			<td id="persistence--retain"><a href="./values.yaml#L127">persistence.retain</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="persistence--size"><a href="./values.yaml#L131">persistence.size</a></td>
			<td>
string
</td>
			<td>
...
"20Gi"
		...
		<tr>
			<td id="persistence--storageClass"><a href="./values.yaml#L133">persistence.storageClass</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="persistence--volumeName"><a href="./values.yaml#L140">persistence.volumeName</a></td>
			<td>
string
</td>
			<td>
...
{}
		...
		<tr>
			<td id="podLabels"><a href="./values.yaml#L359">podLabels</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="podSecurityContext"><a href="./values.yaml#L315">podSecurityContext</a></td>
			<td>
object
</td>
			<td>
...
[]
		...
		<tr>
			<td id="readinessProbe"><a href="./values.yaml#L295">readinessProbe</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "requests": {
    ...
    "memory": "1Gi"
		...
		<tr>
			<td id="runtimeClass"><a href="./values.yaml#L116">runtimeClass</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "tests": ""
		...
		<tr>
			<td id="runtimeClass--pods"><a href="./values.yaml#L118">runtimeClass.pods</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="runtimeClass--tests"><a href="./values.yaml#L120">runtimeClass.tests</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="secrets"><a href="./values.yaml#L181">secrets</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "name": ""
		...
		<tr>
			<td id="secrets--create"><a href="./values.yaml#L183">secrets.create</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="secrets--existingSecret"><a href="./values.yaml#L185">secrets.existingSecret</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="secrets--keys--authToken"><a href="./values.yaml#L196">secrets.keys.authToken</a></td>
			<td>
string
</td>
			<td>
...
"AUTH_TOKEN"
		...
		<tr>
			<td id="secrets--keys--jwtSecret"><a href="./values.yaml#L190">secrets.keys.jwtSecret</a></td>
			<td>
string
</td>
			<td>
...
"JWT_SECRET"
		...
		<tr>
			<td id="secrets--keys--sigKey"><a href="./values.yaml#L192">secrets.keys.sigKey</a></td>
			<td>
string
</td>
			<td>
...
"SIG_KEY"
		...
		<tr>
			<td id="secrets--keys--sigSalt"><a href="./values.yaml#L194">secrets.keys.sigSalt</a></td>
			<td>
string
</td>
			<td>
...
"SIG_SALT"
		...
		<tr>
			<td id="secrets--name"><a href="./values.yaml#L187">secrets.name</a></td>
			<td>
string
</td>
			<td>
...
""
		...
		<tr>
			<td id="securityContext"><a href="./values.yaml#L319">securityContext</a></td>
			<td>
object
</td>
			<td>
...
""
		...
		<tr>
			<td id="startupProbe"><a href="./values.yaml#L305">startupProbe</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "timeoutSeconds": 5
		...
		<tr>
			<td id="tmpVolume"><a href="./values.yaml#L145">tmpVolume</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "sizeLimit": "1Gi"
		...
		<tr>
			<td id="tmpVolume--enabled"><a href="./values.yaml#L147">tmpVolume.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="tmpVolume--mountPath"><a href="./values.yaml#L149">tmpVolume.mountPath</a></td>
			<td>
string
</td>
			<td>
...
"/tmp"
		...
		<tr>
			<td id="tmpVolume--sizeLimit"><a href="./values.yaml#L151">tmpVolume.sizeLimit</a></td>
			<td>
string
</td>
			<td>
...
"1Gi"
		...
		<tr>
			<td id="tolerations"><a href="./values.yaml#L365">tolerations</a></td>
			<td>
list
</td>
			<td>
